...
date: 2025-11-28
category: baseball
image: /Bullpen/assets/images/pena.png
---
...
Contrast this to 2025, and we can see the change he made with his lower body now forward and open ([21 degrees open in 2025 vs. 3 degrees open in 2024](https://baseballsavant.mlb.com/savant-player/jeremy-pena-665161?stats=statcast-r-bat_tracking-mlb#statcast_batting_stance)), allowing him to "square up" on the ball and attack it more aggressively. He's rewarded with the RBI double.

This lets him pull and get under the ball ([Pull AIR % jumped from 15.2% to 21.1% between 2024 and 2025](https://baseballsavant.mlb.com/savant-player/jeremy-pena-665161?stats=statcast-r-hitting-mlb#batted_ball_profile)) more consistently, always a good thing with the Crawford boxes at home.
...
His new approach [plays differently by pitcher](https://www.fangraphs.com/players/jeremy-pena/21636/splits?position=SS&season=2025&split=#Advanced). With lefties, he's patient, resulting in a 9.3 BB% to 13.1 K%. Against right-handed pitchers, he attacks, slashing .311/.368/.490 for a 140 wRC+.
...
Want a specific example? Compared to 2024 when runners advanced successfully [58% of the time, in 2025 he was a cut-down machine, limiting successful advances to 42%](https://baseballsavant.mlb.com/savant-player/jeremy-pena-665161?stats=statcast-r-fielding-mlb#statcast-fielding-baserunning). In fact, name a defensive stat, [Total Zone? Eight runs. DRS? Five runs](https://www.baseball-reference.com/players/p/penaje02.shtml). Pick another? Same story. If that's not Gold Glove calibre, I don't know what is. The only reason I'm not highlighting his second as the culmination of this season is his injury leading to fewer innings in the field.

Could've been better, too. Peña's DP and assist numbers were down from career averages. The culprit might be his double-play partner. In 499.1 innings at second, Jose Altuve turned [22 double plays](https://www.baseball-reference.com/players/a/altuvjo01.shtml). Mauricio Dubón, in just [318 innings, turned 26](https://www.baseball-reference.com/players/d/dubonma01.shtml). Dubón's gone, shipped off for Nick Allen this offseason. That means Altuve is more full-time at second, and Peña's DP numbers likely stay suppressed. But Allen's a killer shortstop who can slide over to second. If he does, Peña's Gold Glove case gets a lot cleaner.
