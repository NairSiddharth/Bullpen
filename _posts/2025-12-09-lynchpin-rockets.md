...
keywords: "Sengun, Şengün, Amen Thompson, Kevin Durant, Houston Rockets, Rockets"
---
...
They've jumped from a 115.37 offensive rating ([13th in the league](https://www.basketball-reference.com/leagues/NBA_2025_ratings.html#ratings::12)) to 123.95 ([2nd](https://www.basketball-reference.com/leagues/NBA_2026_ratings.html#ratings::12)), an 8.5-point leap. The defensive rating slipped slightly from [4th](https://www.basketball-reference.com/leagues/NBA_2025_ratings.html) to [5th](https://www.basketball-reference.com/leagues/NBA_2026_ratings.html#ratings::13), but the improved offense is easily worth it. He's doing all this while fitting into the Rockets' scheme, dropping to a usage rate ([25.7%](https://www.nba.com/stats/player/201142?dir=D&sort=USG_PCT)) that we haven't seen from Durant ever.
...
But can a 37-year-old newcomer truly be the lynchpin? That career-low usage rate cuts both ways. Yes, it shows Durant can defer, but it's been accompanied by a REB% ([6.7%](https://www.nba.com/stats/player/201142?dir=D&sort=REB_PCT)), AST% ([15.7%](https://www.nba.com/stats/player/201142?dir=D&sort=AST_PCT)), and TS% ([61.4%](https://www.nba.com/stats/player/201142?dir=D&sort=TS_PCT)) that are all near career lows. Then again, maybe that suits the Rockets. Houston has Şengün to orchestrate and a system built around [pounding the glass](https://www.nba.com/stats/teams/rebounding?dir=D&sort=REB), they don't need Durant to do everything. They just need him to score, and he's doing that at an elite level.
...
Here's a player doing the most, Alperen Şengün. [Jumping](https://www.espn.com/nba/player/stats/_/id/4871144/alperen-sengun) from averaging 19.1/10.3/4.9 as a first time All-Star in 2024-2025 to averaging 23.1/9.1/7.1 in 2025-2026. Top-10 in apg, top-20 in rpg, and just outside the top-20 in ppg. Doing this while having career high AST/TO ratio ([2.18](https://www.nba.com/stats/player/1630578/advanced?Season=2025-26)) and close to career highs in USG% ([26.1%](https://www.nba.com/stats/player/1630578?dir=D&sort=USG_PCT)) shows how the game is slowing down for Şengün, allowing him to combine efficiency with gaudy box score numbers.
...
Their record over the past two seasons backs that up, [66-29 with him, 1-7 without](https://www.statmuse.com/nba/ask/rockets-record-with-and-without-sengun-tihs-season). Small sample, but the results are consistent. On paper, Şengün looks like the system.

We can't quite anoint Şengün as the lynchpin just yet though. Even with Houston's elite offense this year, Şengün posts a sub-60% TS% ([58.2%](https://www.nba.com/stats/player/1630578?dir=D&sort=TS_PCT)). He shoots just [57.7% at the rim and 34.3% from midrange](https://3stepsbasket.com/player/alperen-sengun/shooting). Those are below-average numbers for a starting center. Last year with worse spacing, his efficiency was even lower at [54.5%](https://www.nba.com/stats/player/1630578?dir=D&sort=TS_PCT). This year, Durant's arrival changed things. Defenses can't load up on Şengün anymore without leaving Durant open. It's clearly benefited his efficiency, which is still below average but functional. The offense jumped from 13th last season to 2nd this season, but was that Şengün's playmaking or Durant forcing defenses to respect the Rockets' scoring? If Şengün needed an elite scorer to make the offense work at this level, maybe he's not the lynchpin.
...
The eye test matches the numbers. Thompson ranks [11th in NBA in defensive rating](https://www.nba.com/stats/players/advanced?CF=MIN*GE*24:GP*GE*15&SeasonType=Regular%20Season&dir=-1&sort=DEF_RATING) among qualified players (107.1). Given that the Rockets post a 112.23 defensive rating overall (good for 5th in NBA), it's clear that without Thompson, the defense would be much worse.

Lineup data backs this up. Thompson appears in [four of Houston's five](https://www.nba.com/stats/lineups/advanced?CF=MIN*G*200&GroupQuantity=3&TeamID=1610612745&dir=D&slug=advanced&sort=NET_RATING) best three-man combinations by net rating (minimum 200 minutes). The Rockets' most effective units aren't just built around him, they require him. His defensive versatility allows Houston to play multiple styles, switching everything on defense while maintaining offensive spacing. But defense is only half the battle.

He's trying to take it to the next level. His assists have grown from [3.8 to 5.1](https://www.nba.com/stats/player/1641708?dir=D&sort=AST), and his free throw shooting jumped from [68.4% to 80%](https://www.nba.com/stats/player/1641708?dir=D&sort=FT_PCT), showing real skill development. But the transition isn't smooth. He's attempting more threes to space the floor (2.1 per game vs 1.3), but shooting just 19% on them, down from 27.5% last year. His TS% has dropped from [60.2% to 54.1%](https://www.nba.com/stats/player/1641708?dir=A&sort=TS_PCT) as a result. He's averaging [17.4 points, up from 14.1 last year](https://www.espn.com/nba/player/stats/_/id/4684740/amen-thompson) but the efficiency isn't there (yet).
