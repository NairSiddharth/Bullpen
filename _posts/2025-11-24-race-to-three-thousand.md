...
Baseball, of course, isn't that simple. All the skills in baseball have a physical peak, plateau for a short while, then begin to drop off. For example, [batting average typically depends on reaction time and bat speed](https://thedynastyguru.com/2019/02/27/aging-gracefully-approaching-aging-curves-and-advanced-stats-part-ii/), peaking around ages 26 to 27. Decline can be offset to some degree with improved experience. With Altuve's declining batting average in recent years (.265 in 2025 vs. .295 in 2024 vs. .303 career average), it raises legitimate concerns about sustaining his elite contact ability. Applying an [ageing curve](https://community.fangraphs.com/joint-model-of-the-war-aging-curve/) to Altuve's projections while accounting for his ironman status and the increased likelihood of rest days and minor injuries, we get the following.

![Aging curve projections for Altuve]({{ site.baseurl }}/assets/images/NoLockout_AgingCurve.png)

*Figure 2: Projections based on the joint WAR aging model detailed in [FanGraphs - Joint Model of the WAR Aging Curve](https://community.fangraphs.com/joint-model-of-the-war-aging-curve/) and [DynastyGurus - Aging Gracefully Part I and Part II](https://thedynastyguru.com/2019/02/27/aging-gracefully-approaching-aging-curves-and-advanced-stats-part-ii/).*
...
That doesn't even begin to incorporate the [looming lockout](https://apnews.com/article/mlb-lockout-salary-cap-b2abf5a48833dac97d65dc92ce32d0bb) on the horizon after the 2026 season, which, if not handled in a timely fashion, would take games away from the 2027 regular season. Every missed game is one fewer opportunity, and as just discussed, with Altuve's skills declining, those opportunities grow increasingly valuable.

![Lockout scenario projections]({{ site.baseurl }}/assets/images/Lockout_AgingCurve.png)

*Figure 3: Hit Projections based on the joint WAR ageing model detailed in [FanGraphs - Joint Model of the WAR Aging Curve](https://community.fangraphs.com/joint-model-of-the-war-aging-curve/) and [DynastyGurus - Aging Gracefully Part I and Part II](https://thedynastyguru.com/2019/02/27/aging-gracefully-approaching-aging-curves-and-advanced-stats-part-ii/), and applying various lockout scenarios for 2027.*
...
Fortunately for Altuve, the future isn't set by my spreadsheets, and we can look to historical precedent for an alternative path to the 3,000-hit club. Astros fans may remember another legend's pursuit of 3,000: Craig Biggio. From 2002 to 2007, he was at best a [league-average offensive player, and at worst below average](https://www.fangraphs.com/players/craig-biggio/549/stats?position=2B) for the Astros per [fWAR](https://library.fangraphs.com/war/differences-fwar-rwar/). Despite that, they gave him yearly extensions and played him because he was serviceable on the field, instrumental to the Astros, and was chasing history. Altuve has brought the Astros multiple championships, an MVP, and [countless clutch hits](https://www.youtube.com/watch?v=esxuHHHnA2M) (I've linked my favorite) over what will be more than two decades with the franchise. The organization extended Biggio to chase history, and they will likely do the same for Altuve if he wants to stick around for the chase. As shown in the projections below, even with a partial season lockout, there's a high likelihood Altuve reaches 3,000 hits if his contract is extended until he's forty-two.

![Extended contract projections]({{ site.baseurl }}/assets/images/ExtendedContract_LockoutScenarios.png)

*Figure 4: Hit Projections based on the joint WAR aging model detailed in [FanGraphs - Joint Model of the WAR Aging Curve](https://community.fangraphs.com/joint-model-of-the-war-aging-curve/) and [DynastyGurus - Aging Gracefully Part I and Part II](https://thedynastyguru.com/2019/02/27/aging-gracefully-approaching-aging-curves-and-advanced-stats-part-ii/), taken past Altuve's contract ending in 2029 to simulate Craig Biggio's hunt for 3000.*
