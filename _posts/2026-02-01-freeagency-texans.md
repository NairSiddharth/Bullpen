---
title: "Houston Texans: Free Agents to Target"
seo_title: "Texans 2026 Free Agency Targets: OL, RB, WR, TE Needs"
date: 2026-02-01
categories: 
    - football
tags:
  - free-agency
image: /assets/images/houston-texans-free-agency.png
excerpt: After a divisional round loss, the Texans need to fix their offensive line, running game, and depth. Here's who fits the scheme and cap.
layout: post
description: A comprehensive breakdown of Houston Texans free agency targets for 2026, analyzing offensive line needs (David Edwards, Cade Mays), running back options (Kenneth Walker, Breece Hall), and skill position depth including DeAndre Hopkins' potential return.
---

<div class="wide">
<figure>
<img src="{{ site.baseurl }}/assets/images/captainamerica_chair_meme.png" alt="Captain America Chair Meme">
<figcaption>Captain America sitting in chair</figcaption>
</figure>
</div>

So, you believed in the Texans getting past the Divisional Round? Me too. The league's best defense and a 10-game winning streak said so. Getting their teeth kicked in by the Patriots in yet another [divisional round loss](https://www.espn.com/nfl/boxscore/_/gameId/401772983) proved otherwise.
...
Offensive linemen aren't the calendar models of the NFL. More like Mack trucks. But they do the unsexy work that wins championships. The Texans finished [30th in pass block win rate and dead last in run block win rate](https://www.espn.com/nfl/story/_/id/46138675/2025-nfl-win-rates-top-teams-players-rankings-pass-run-block#prwr). Stroud has been sacked [113 times in 46 career starts](https://www.pro-football-reference.com/players/S/StroCJ00.htm). That's not a quarterback problem. That's a protection problem.

**David Edwards (Guard):**

<div class="wide">
<figure>
<img src="{{ site.baseurl }}/assets/images/davidedwards-freeagency.png" alt="David Edwards set">
<figcaption>David Edwards at the line</figcaption>
</figure>
</div>
...
<div class="wide">
<figure>
<img src="{{ site.baseurl }}/assets/images/cademays-freeagency.png" alt="Cade Mays in protection">
<figcaption>Cade Mays set at line</figcaption>
</figure>
</div>

There's already smoke here. [Tony Pauline of EssentiallySports](https://www.si.com/nfl/texans/onsi/news/houston-texans-poised-pursue-carolina-panthers-free-agent-cade-mays) reported the Texans have "rumored interest" in the Panthers center, who isn't expected to return to Carolina. Where there's smoke, there's usually Nick Caserio.
...
The Eagles have both tackles locked up, so Johnson will test the market. He's not elite (76th of 85 tackles per PFF, [eight sacks allowed](https://www.pro-football-reference.com/players/J/JohnFr01.htm)), but he's proven in big games and should [come cheap](https://www.spotrac.com/nfl/player/market-value/_/id/29327/fred-johnson). If the Texans want tackle insurance for Aireontae Ersery, Johnson is a proven commodity who's played when it matters.
...
<div class="wide">
<figure>
<img src="{{ site.baseurl }}/assets/images/breece-hall-texan.png" alt="Breece Hall cuts up field">
<figcaption>Breece Hall cuts up field</figcaption>
</figure>
</div>
...
<div class="wide">
<figure>
<img src="{{ site.baseurl }}/assets/images/kenneth-walker-freeagency.png" alt="Kenneth Walker angry run">
<figcaption>Kenneth Walker angry run</figcaption>
</figure>
</div>
...
<div class="wide">
<figure>
<img src="{{ site.baseurl }}/assets/images/dhop-return.png" alt="DeAndre Hopkins photoshop in Texans jersey :)">
<figcaption>Stunning photoshop of DeAndre Hopkins in a Texans Jersey</figcaption>
</figure>
</div>
...
Dalton Schultz isn't the problem. He set career highs in [receptions (82) and yards (777)](https://www.pro-football-reference.com/players/S/SchuDa00.htm) this season. He's reliable. He's also 29, making [$12 million AAV](https://www.spotrac.com/nfl/player/_/id/25238/dalton-schultz), with a non-guaranteed 2026 salary.

If the Texans want an out, Okonkwo is the name. He's 26, athletic, led the Titans in [receiving yards](https://www.pro-football-reference.com/players/O/OkonCh00.htm) despite Tennessee's moribund offense. The concern is blocking, which matters in Caley's gap-heavy system. He'd cost [$6-8 million AAV](https://www.spotrac.com/nfl/player/market-value/_/id/77020/chig-okonkwo).
...
<div class="wide">
<figure>
<img src="{{ site.baseurl }}/assets/images/germaine-pratt-signing.png" alt="Germaine Pratt on the field">
<figcaption>Germaine Pratt upends player</figcaption>
</figure>
</div>
...
With Indianapolis he [started 12 games](https://www.pro-football-reference.com/players/P/PratGe00.htm) and racked up 101 tackles. Made 101 of 107 attempts. That efficiency is absurd. He added an interception (picked off Trevor Lawrence in Week 17), three pass breakups, and a fumble recovery. The Colts needed a warm body at linebacker. Pratt gave them a legitimate starter.
...
The Texans' defense under DeMeco Ryans and Matt Burke is built on [simplicity](https://www.matchquarters.com/p/houston-texans-defense-demeco-ryans-scheme): low blitz rates, high zone usage, linebackers who flow sideline-to-sideline and drop into coverage. Henry To'o'To'o and Azeez Al-Shaair are athletic and rangy, perfect for that system. Pratt isn't that. His coverage grades are inconsistent, and asking him to do what the starters do would be a square peg in a round hole.
...
The real separator is playmaking. [Quay Walker](https://www.pro-football-reference.com/players/W/WalkQu00.htm) (the other name floating around) has zero interceptions in four NFL seasons. Pratt has seven in six. The coverage concerns are real, but seven picks says he finds the ball when it matters.
...
But Spotrac projects his market value at [$2.87M AAV](https://www.spotrac.com/nfl/player/market-value/_/id/29108/germaine-pratt). For a rotational run-stuffer with ball skills at that price? That's a steal.
